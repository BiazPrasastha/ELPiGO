        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="amount" id="exampleInputEmail1"
                    placeholder="Enter LPG Amount" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="subsidi" value="1" type="checkbox" required>
                    <label class="form-check-label">Subsidi</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="subsidi" value="0" type="checkbox" required>
